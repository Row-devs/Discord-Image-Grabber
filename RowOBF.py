...
class RowOBF:
    ...
    def encrypt1(self):
        ...
        init = ";".join(init)
        self.code = f'''
# Obfuscated using https://github.com/Row-c/RowOBF
...
'''.strip().encode()
    ...
    def encrypt2(self):
        ...
        self.code = f'''# Obfuscated using https://github.com/Row-c/RowOBF
